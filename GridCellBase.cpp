...
CCellRange CGridCellBase::GetMergeRange() const
{
	return m_MergeRange;
}
...
CCellID CGridCellBase::GetMergeCellID() const
{
	return m_MergeCellID;
}

bool CGridCellBase::IsMergeWithOthers() const
{
	return m_IsMergeWithOthers;
}

bool CGridCellBase::IsShow() const
{
	return !m_Hide;
}
